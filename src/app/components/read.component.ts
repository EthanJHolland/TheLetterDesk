...
export class ReadComponent{
    ...
    output: any = null; //what div the letter is typed into
    ...
    open(){
        ...
        $(".logo").toggleClass("typing"); //fade out the logo
        ...
        this.output = document.getElementsByClassName("words")[0]; //what div the letter is typed into
        ...
        //start clock -- don't use for now because testing revealed people don't care
        // this.startClock();
    }
    ...
    updateString(index) {
        //progress (time) bar
        document.getElementsByClassName("time")[0].innerHTML = this.i+1 + " / " + this.order.length;
        ...
        if (index<this.order.length-1) {
            ...
            this.output.innerHTML = this.totalString + "|";
        } 
        else {
    ...
    Digital=new Date("Sun, 22 Nov 2017 15:08:03"); //insert the start time
    startClock(){
        this.Digital.setSeconds(this.Digital.getSeconds() + 1);
        var hours = this.Digital.getHours();
        var minutes: number = this.Digital.getMinutes();
        var seconds: number = this.Digital.getSeconds();
        ...
        document.getElementsByClassName("time")[0].innerHTML = hours+":"+minutesString+":"+secondsString+" "+dn;
